(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminArchiveComponent = /** @class */ (function () {
                function AdminArchiveComponent(archiveService) {
                    this.archiveService = archiveService;
                    this.archiveOrders = [];
                }
                AdminArchiveComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.archiveService.getData().subscribe(function (actionArray) {
                        _this.archiveOrders = actionArray.map(function (order) {
                            return Object.assign({ id: order.payload.doc.id }, order.payload.doc.data());
                        });
                    });
                };
                // Сортування замовлень - нові відображаються зверху
                AdminArchiveComponent.prototype.sortArray = function (a, b) {
                    return new Date(b.date).getTime() - new Date(a.date).getTime();
                };
                ;
                //Загальна сума замовлення клієнта
                AdminArchiveComponent.prototype.orderSum = function (product) {
                    return product.reduce(function (accumulator, value) { return accumulator + value.price * value.count; }, 0);
                };
                ;
                //Очищення всього архіву
                AdminArchiveComponent.prototype.deleteAllArchive = function () {
                    this.archiveService.deleteArray(this.archiveOrders);
                };
                ;
                return AdminArchiveComponent;
            }());
            AdminArchiveComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminBlacklistComponent = /** @class */ (function () {
                function AdminBlacklistComponent(blacklistService, userService, dialog, modalService, notificationsService) {
                    ...
                    this.trackByPackId = function (index, pack) { return pack.id; };
                }
                AdminBlacklistComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.blacklistService.getData().subscribe(function (actionArray) {
                        _this.blockedUsers = actionArray.map(function (post) {
                            return Object.assign({ id: post.payload.doc.id }, post.payload.doc.data());
                        });
                    });
                    this.userService.getData().subscribe(function (actionArray) {
                        _this.allUsers = actionArray.map(function (user) {
                            return Object.assign({ id: user.payload.doc.id }, user.payload.doc.data());
                        });
                    });
                };
                AdminBlacklistComponent.prototype.unblockModalUser = function (template, user) {
                    this.modalRef = this.modalService.show(template);
                    this.blackListUser = user;
                    this.unblockUser = this.allUsers.find(function (chsnUser) { return chsnUser.username === user.username; });
                };
                ;
                AdminBlacklistComponent.prototype.confirmUnblockUser = function () {
                ...
                ;
                AdminBlacklistComponent.prototype.closeWindow = function () {
                    this.modalRef.hide();
                };
                ;
                return AdminBlacklistComponent;
            }());
            AdminBlacklistComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminCategoriesComponent = /** @class */ (function () {
                function AdminCategoriesComponent(service, productService, firestore, modalService, notificationsService) {
                ...
                AdminCategoriesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.service.getData().subscribe(function (actionArray) {
                        _this.categories = actionArray.map(function (category) {
                            return Object.assign({ id: category.payload.doc.id }, category.payload.doc.data());
                        });
                    });
                    this.productService.getData().subscribe(function (actionArray) {
                        _this.allProducts = actionArray.map(function (product) {
                ...
                AdminCategoriesComponent.prototype.setData = function () {
                    var _this = this;
                    if (this.categories.find(function (searchCategory) { return searchCategory.name === _this.categoryName; })) {
                        this.notificationsService.warningNotification("This category already exists");
                    }
                    else {
                        var newCategory = new src_app_shared_classes_category_model__WEBPACK_IMPORTED_MODULE_6__["Category"](this.categoryName);
                ...
                ;
                AdminCategoriesComponent.prototype.deleteData = function (category, template) {
                    this.deleteCategory = category;
                    this.modalRef = this.modalService.show(template);
                    this.categoryName = '';
                    this.deleteArrayProductsThisCategory = this.allProducts.filter(function (val) { return val.category === category.name; });
                };
                ;
                //Видалення категорії та усіх товарів, які належать до неї
                AdminCategoriesComponent.prototype.confirmDeleteCategory = function () {
                ...
                ;
                AdminCategoriesComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                ;
                AdminCategoriesComponent.prototype.checkCategoryValue = function (event) {
                    var regExp = /^([a-zA-Z]{1,})([\s]{1})?([a-zA-Z]{1,})?$/;
                    var check = regExp.test(event.target.value);
                    if (!check) {
                        event.target.value = '';
                        this.categoryButtonAddCheck = false;
                    }
            ...
            AdminCategoriesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminFeedbackComponent = /** @class */ (function () {
                function AdminFeedbackComponent(postService, dialog, modalService, userService, blackListService, notificationsService) {
                ...
                AdminFeedbackComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.postService.getData().subscribe(function (actionArray) {
                        _this.posts = actionArray.map(function (post) {
                            return Object.assign({ id: post.payload.doc.id }, post.payload.doc.data());
                        });
                    });
                };
                // Сортування постів - нові відображаються зверху
                AdminFeedbackComponent.prototype.sortArray = function (a, b) {
                    return new Date(b.date).getTime() - new Date(a.date).getTime();
                };
                ;
                AdminFeedbackComponent.prototype.blockModalUser = function (template, user) {
                    this.modalRef = this.modalService.show(template);
                    this.chosenUser = user;
                };
                ;
                //Змінюю статус юзеру і кидаю в blackListService
                AdminFeedbackComponent.prototype.confirmBlockUser = function () {
                    var blockedUser = new src_app_shared_classes_user_model__WEBPACK_IMPORTED_MODULE_6__["User"](this.chosenUser.username, this.chosenUser.email, this.chosenUser.password, { isBlackList: true, reason: this.userReasonBlock });
                    var userPosts = this.posts.filter(function (posts) { return posts.writtenBy.username === blockedUser.username; });
                ...
                ;
                AdminFeedbackComponent.prototype.closeWindow = function () {
                    this.modalRef.hide();
                    this.userReasonBlock = '';
                };
                ;
            ...
            AdminFeedbackComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_app_shared_services_notification_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/services/notification.service */ "./src/app/shared/services/notification.service.ts");
            var AdminGuestsComponent = /** @class */ (function () {
                function AdminGuestsComponent(service, firestore, prStorage, modalService, notificationsService) {
                    this.service = service;
                    this.firestore = firestore;
                ...
                AdminGuestsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.service.getData().subscribe(function (actionArray) {
                        _this.guests = actionArray.map(function (guests) {
                            return Object.assign({ id: guests.payload.doc.id }, guests.payload.doc.data());
                        });
                    });
                    this.service.getType().subscribe(function (actionArray) {
                        _this.mainType = actionArray.map(function (type) {
                            return Object.assign({ id: type.payload.doc.id }, type.payload.doc.data());
                        });
                        _this.showButtonType = _this.mainType[0].name;
                    });
                };
                AdminGuestsComponent.prototype.openGuestModal = function (template) {
                    this.resetData();
                    this.modalRef = this.modalService.show(template);
                };
                ;
                // Завантаження картинки
                AdminGuestsComponent.prototype.upload = function (event) {
                    var _this = this;
                    ...
                    this.task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        ...
                        _this.downloadURL.subscribe(function (url) { return _this.guestPhoto = url; });
                        _this.progress = false;
                        _this.addGuestPhotoCheck = true;
                    })).subscribe();
                };
                ;
                AdminGuestsComponent.prototype.setData = function () {
                    var newGuest = new src_app_shared_classes_guest_model__WEBPACK_IMPORTED_MODULE_7__["Guest"](this.guestName, this.guestPhoto, this.guestQuote, this.guestInfo);
                ...
                ;
                AdminGuestsComponent.prototype.resetData = function () {
                    this.guestName = '';
                    this.guestPhoto = '';
                    this.guestQuote = '';
                    this.guestInfo = '';
                ...
                ;
                AdminGuestsComponent.prototype.deleteData = function (guest, template) {
                    this.deleteGuest = guest;
                    this.modalRef = this.modalService.show(template);
                };
                ;
                AdminGuestsComponent.prototype.confirmDeleteGuest = function () {
                    this.service.deleteData(this.deleteGuest);
                    this.modalRef.hide();
                    this.notificationsService.successNotification("Guest successfully deleted");
                };
                ;
                AdminGuestsComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                ;
                AdminGuestsComponent.prototype.cancelData = function () {
                    this.modalRef.hide();
                    this.resetData();
                };
                ;
                //Встановлення типу, який відображається на головній сторінці
                AdminGuestsComponent.prototype.setType = function () {
                    var newType = new src_app_shared_classes_type_model__WEBPACK_IMPORTED_MODULE_8__["Type"](this.anotherType);
                ...
                ;
                return AdminGuestsComponent;
            }());
            AdminGuestsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminOrdersComponent = /** @class */ (function () {
                function AdminOrdersComponent(orderService, productService, categoryService, firestore, dialog, modalService, archiveService, notificationsService) {
                ...
                AdminOrdersComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.orderService.getData().subscribe(function (actionArray) {
                        _this.orders = actionArray.map(function (order) {
                            return Object.assign({ id: order.payload.doc.id }, order.payload.doc.data());
                        });
                    });
                    //Наявні категорії продуктів. Потрібно при додаванні нового продукту до замовлення
                    this.categoryService.getData().subscribe(function (actionArray) {
                        _this.categories = actionArray.map(function (category) {
                            return Object.assign({ id: category.payload.doc.id }, category.payload.doc.data());
                        });
                    });
                    ...
                    this.productService.getData().subscribe(function (actionArray) {
                        _this.products = actionArray.map(function (product) {
                            return Object.assign({ id: product.payload.doc.id }, product.payload.doc.data());
                        });
                    });
                };
                ;
                AdminOrdersComponent.prototype.editUserModal = function (template, order) {
                    this.modalRef = this.modalService.show(template);
                ...
                ;
                AdminOrdersComponent.prototype.cancelOrderModal = function (template, order, product) {
                    this.modalRef = this.modalService.show(template);
                ...
                ;
                AdminOrdersComponent.prototype.confirmDeleteOrder = function () {
                ...
                AdminOrdersComponent.prototype.confirmDeleteProduct = function () {
                    var _this = this;
                    var index = this.changeOrder.product.findIndex(function (findProd) { return findProd.id === _this.changeProduct.id; });
                    this.changeOrder.product.splice(index, 1);
                    var newOrder = new src_app_shared_classes_order_model__WEBPACK_IMPORTED_MODULE_11__["Order"](this.changeOrder.name, this.changeOrder.adress, this.changeOrder.number, this.changeOrder.date, this.changeOrder.product, false);
                ...
                ;
                AdminOrdersComponent.prototype.addProductModal = function (template, order) {
                    this.modalRef = this.modalService.show(template);
                    this.editOrder = order;
                    this.editId = order.id;
                };
                ;
                AdminOrdersComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                ;
                //Загальна сума замовлення клієнта
                AdminOrdersComponent.prototype.orderSum = function (product) {
                    return product.reduce(function (accumulator, value) { return accumulator + value.price * value.count; }, 0);
                };
                ;
                // Редагування адреси і імені користувача
                AdminOrdersComponent.prototype.updateUserData = function () {
                    var newOrder = new src_app_shared_classes_order_model__WEBPACK_IMPORTED_MODULE_11__["Order"](this.regForm.name, this.regForm.adress, this.editOrder.number, this.editOrder.date, this.editOrder.product, false);
                    this.orderService.updateData(newOrder, this.editId);
                    this.editId = '';
                    this.modalRef.hide();
                ...
                AdminOrdersComponent.prototype.filterCategory = function () {
                    var _this = this;
                    this.filterProducts = this.products.filter(function (val) { return val.category === _this.productCategory.trim(); });
                    this.productName = '';
                    this.productCount = null;
                };
                ;
                //Добавлення нового продукту в замовлення
                AdminOrdersComponent.prototype.addProduct = function () {
                    var _this = this;
                    var product = this.filterProducts.filter(function (val) { return val.name === _this.productName; })[0];
                    product.count = Number(this.productCount);
                    //Якщо такий продукт вже є, то міняю його count
                    if (this.editOrder.product.find(function (allProducts) { return allProducts.id === product.id; })) {
                        var index = this.editOrder.product.findIndex(function (elements) { return elements.id === product.id; });
                    ...
                    ;
                    var newOrder = new src_app_shared_classes_order_model__WEBPACK_IMPORTED_MODULE_11__["Order"](this.editOrder.name, this.editOrder.adress, this.editOrder.number, this.editOrder.date, this.editOrder.product, false);
                    this.orderService.updateData(newOrder, this.editId);
                    this.editId = '';
                ...
                AdminOrdersComponent.prototype.changeOrderState = function (order) {
                    if (order.isNew) {
                        var newOrder = new src_app_shared_classes_order_model__WEBPACK_IMPORTED_MODULE_11__["Order"](order.name, order.adress, order.number, order.date, order.product, false);
                        this.editId = order.id;
                        this.orderService.updateData(newOrder, this.editId);
                        this.editId = '';
                    }
                ...
                ;
                AdminOrdersComponent.prototype.deliveredOrder = function (order) {
                ...
                // Сортування замовлень - нові відображаються зверху
                AdminOrdersComponent.prototype.sortArray = function (a, b) {
                    return new Date(b.date).getTime() - new Date(a.date).getTime();
                };
                ;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminProductsComponent = /** @class */ (function () {
                function AdminProductsComponent(service, categoryService, route, prStorage, firestore, modalService, notificationsService) {
                    this.service = service;
                    this.categoryService = categoryService;
                    this.route = route;
                    this.prStorage = prStorage;
                ...
                ;
                //Завантаження фото
                AdminProductsComponent.prototype.upload = function (event) {
                    var _this = this;
                    this.editProductImgBoolean = false;
                    var id = Math.random().toString(36).substring(2);
                    this.progress = true;
                    this.ref = this.prStorage.ref("images/" + id);
                    this.task = this.ref.put(event.target.files[0]);
                    this.uploadState = this.task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (s) { return s.state; }));
                    this.uploadProgress = this.task.percentageChanges();
                    this.task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
                        _this.downloadURL = _this.ref.getDownloadURL();
                        _this.downloadURL.subscribe(function (url) { return _this.productImage = url; });
                        _this.progress = false;
                        _this.addProductCheck = true;
                    })).subscribe();
                };
                //Роблю кнопку категорії активною
                AdminProductsComponent.prototype.isActive = function (item) {
                    return this.selected === item;
                };
                ;
                AdminProductsComponent.prototype.openProductModal = function (template) {
                    this.resetData();
                ...
                ;
                AdminProductsComponent.prototype.setData = function () {
                    var _this = this;
                    var newProduct = new src_app_shared_classes_product_model__WEBPACK_IMPORTED_MODULE_9__["Product"](this.productCategory, this.productName, this.productDescription, this.productPrice, this.productCount, this.productImage, this.productSize, this.productWeight);
                    ...
                    if (this.productId) {
                        ...
                        if (this.products
                            .filter(function (product) { return product.category === _this.productCategory; })
                            .some(function (product) { return product.name === _this.productName; })) {
                ...
                ;
                AdminProductsComponent.prototype.cancelData = function () {
                    this.modalRef.hide();
                    this.resetData();
                };
                ;
                AdminProductsComponent.prototype.filterCategory = function () {
                    this.productSize = null;
                    this.productWeight = null;
                };
                ;
                AdminProductsComponent.prototype.resetData = function () {
                    this.productCategory = '';
                    this.productName = '';
                ...
                ;
                AdminProductsComponent.prototype.editData = function (product, template) {
                    this.modalRef = this.modalService.show(template);
                ...
                ;
                AdminProductsComponent.prototype.deleteData = function (product, template) {
                    this.deleteProduct = product;
                    this.modalRef = this.modalService.show(template);
                };
                ;
                AdminProductsComponent.prototype.confirmDeleteProduct = function () {
                ...
                ;
                AdminProductsComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                ;
                AdminProductsComponent.prototype.cancelDeleteProduct = function () {
                    this.modalRefWarning.hide();
                };
                ;
                AdminProductsComponent.prototype.selectCategory = function (name) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(localStorage) {
                ...
                HeaderComponent.prototype.getCount = function () {
                    var _this = this;
                    this.localStorage.ordersStream.subscribe(function (data) { return _this.orderCount = data.length; });
                };
                ;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaginatorComponent = /** @class */ (function () {
                function PaginatorComponent(paginatorService, route) {
                    this.paginatorService = paginatorService;
                    this.route = route;
                }
                PaginatorComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.paginatorService.currentPage.subscribe(function (page) { return _this.page = page; });
                };
                PaginatorComponent.prototype.changePage = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BasketComponent = /** @class */ (function () {
                function BasketComponent(productService, _formBuilder, orderService, localStorageService, dialog, modalService, notificationsService, route) {
                    this.productService = productService;
                ...
                ;
                BasketComponent.prototype.checkBasketArray = function () {
                ...
                ;
                //Сума замовлення
                BasketComponent.prototype.reduce = function () {
                    this.orderSum = this.localProducts.reduce(function (accumulator, value) { return accumulator + value.price * value.count; }, 0);
                };
                ;
                BasketComponent.prototype.countProductsInc = function (product) {
                    product.count++;
                    this.changeCountInLocalStorage(product);
                    this.reduce();
                };
                ;
                BasketComponent.prototype.countProductsDec = function (product) {
                    if (product.count > 1) {
                        product.count--;
                        this.changeCountInLocalStorage(product);
                        this.reduce();
                ...
                ;
                BasketComponent.prototype.changeCountInLocalStorage = function (chosenProduct) {
                    var localStorageArray = this.localStorageService.getDataLocalStorage('Products');
                    var index = localStorageArray.findIndex(function (elem) { return elem.id === chosenProduct.id; });
                    localStorageArray.splice(index, 1, chosenProduct);
                    this.localStorageService.setProductLocalStorage(localStorageArray);
                };
                ;
                BasketComponent.prototype.checkCountProduct = function (event, product) {
                    var regExp = /^[1-9]{1}([0-9]{1})?([0-9]{1})?$/;
                    var check = regExp.test(event.target.value);
                    if (check) {
                ...
                ;
                BasketComponent.prototype.deletePoduct = function (product) {
                    var products = this.localStorageService.getDataLocalStorage('Products');
                    var index = products.findIndex(function (findProduct) { return findProduct.id === product.id; });
                ...
                ;
                BasketComponent.prototype.setOrder = function () {
                    var newOrder = new src_app_shared_classes_order_model__WEBPACK_IMPORTED_MODULE_7__["Order"](this.userName.value, this.userAdress.value, this.userNumber.value, new Date(), this.localProducts, true);
                ...
                ;
                BasketComponent.prototype.closeWindow = function () {
                    this.modalRef.hide();
                };
                ;
                Object.defineProperty(BasketComponent.prototype, "userName", {
                    get: function () {
                ...
                ;
                Object.defineProperty(BasketComponent.prototype, "userAdress", {
                    get: function () {
                ...
                ;
                Object.defineProperty(BasketComponent.prototype, "userNumber", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-bootstrap/modal */ "./node_modules/ngx-bootstrap/modal/fesm2015/ngx-bootstrap-modal.js");
            /* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
            var FeedbackAuthorizationComponent = /** @class */ (function () {
                function FeedbackAuthorizationComponent(userService, route, localStorageService, dialog, modalService) {
                    this.userService = userService;
                    this.route = route;
                    this.localStorageService = localStorageService;
                    this.dialog = dialog;
                ...
                FeedbackAuthorizationComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    window.scrollTo(0, 0);
                    ...
                    this.userService.getData().subscribe(function (actionArray) {
                        _this.users = actionArray.map(function (user) {
                            return Object.assign({ id: user.payload.doc.id }, user.payload.doc.data());
                        });
                    });
                ...
                ;
                FeedbackAuthorizationComponent.prototype.changeAnimationState = function (subject) {
                    return subject === 'end' ? 'start' : 'end';
                };
                ;
                //Перевірка логування / реєстрації
                FeedbackAuthorizationComponent.prototype.checkLog = function () {
                ...
                FeedbackAuthorizationComponent.prototype.signUp = function () {
                    if (this.form.valid) {
                        var formData = Object.assign({}, this.form.value);
                        var newUser_1 = new src_app_shared_classes_user_model__WEBPACK_IMPORTED_MODULE_6__["User"](formData.username, formData.email, formData.password, this.blackList);
                        console.log(newUser_1);
                        this.existingName = this.users.some(function (user) { return user.username === newUser_1.username; });
                        this.existingEmail = this.users.some(function (user) { return user.email === newUser_1.email; });
                        //Якщо такого нікнейму і мейлу нема, то перекидає на іншу компоненту
                        if (!this.existingName && !this.existingEmail) {
                            this.userService.setData(newUser_1);
                            this.localStorageService.setUserLocalStorage(newUser_1.username);
                            this.form.reset();
                            this.checkAuthorization();
                        }
                    }
                ...
                ;
                FeedbackAuthorizationComponent.prototype.checkAuthorization = function () {
                    if (this.localStorageService.getDataLocalStorage('User').length > 0) {
                        this.route.navigate(['feedback/home']);
                    }
                };
                ;
                FeedbackAuthorizationComponent.prototype.logIn = function (template) {
                    ...
                    var formData = Object.assign({}, this.form.value);
                    if (this.users.some(function (user) { return user.username === formData.username && user.password === formData.password; })) {
                        var searchUser = this.users.find(function (user) { return user.username === formData.username && user.password === formData.password; });
                ...
                ;
                FeedbackAuthorizationComponent.prototype.closeWindow = function () {
                    this.modalRef.hide();
                };
                ;
                return FeedbackAuthorizationComponent;
            }());
            FeedbackAuthorizationComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FeedbackHomeComponent = /** @class */ (function () {
                function FeedbackHomeComponent(localStorageService, route, paginatorService, userService, postService, dialog, modalService) {
                    this.localStorageService = localStorageService;
                    this.route = route;
                    this.paginatorService = paginatorService;
                    this.userService = userService;
                ...
                FeedbackHomeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.postService.getData().subscribe(function (actionArray) {
                        _this.posts = actionArray.map(function (post) {
                            return Object.assign({ id: post.payload.doc.id }, post.payload.doc.data());
                        });
                        _this.posts.length > 30 ? _this.checkPaginator = true : _this.checkPaginator = false;
                    });
                    this.userService.getData().subscribe(function (actionArray) {
                        _this.users = actionArray.map(function (user) {
                            return Object.assign({ id: user.payload.doc.id }, user.payload.doc.data());
                ...
                ;
                FeedbackHomeComponent.prototype.checkAuthorization = function () {
                    var _this = this;
                    var checkUser = this.localStorageService.getDataLocalStorage('User');
                    if (checkUser.length === 0) {
                        this.route.navigate(['feedback/authorization']);
                    }
                    else {
                        this.userName = checkUser[0];
                        var check = this.users.find(function (user) { return user.username === _this.userName; });
                ...
                ;
                FeedbackHomeComponent.prototype.logOut = function () {
                    localStorage.removeItem('User');
                    this.checkAuthorization();
                };
                ;
                FeedbackHomeComponent.prototype.openModal = function (template) {
                    this.modalRef = this.modalService.show(template);
                    this.postButtonName = 'Add';
                };
                ;
                FeedbackHomeComponent.prototype.deletePost = function (template, post) {
                    this.modalRef = this.modalService.show(template);
                    this.chosenPost = post;
                };
                ;
                FeedbackHomeComponent.prototype.confirmDeletePost = function () {
                    this.postService.deleteData(this.chosenPost);
                    this.modalRef.hide();
                };
                ;
                FeedbackHomeComponent.prototype.decline = function () {
                    this.modalRef.hide();
                };
                ;
                FeedbackHomeComponent.prototype.addPost = function () {
                    var _this = this;
                    var user = this.users.filter(function (user) { return user.username === _this.userName; })[0];
                    var newPost = new src_app_shared_classes_post_model__WEBPACK_IMPORTED_MODULE_9__["Post"](this.userPostText, user, new Date());
                ...
                ;
                FeedbackHomeComponent.prototype.editPost = function (template, post) {
                ...
                FeedbackHomeComponent.prototype.sortArray = function (a, b) {
                    return new Date(b.date).getTime() - new Date(a.date).getTime();
                };
                ;
                return FeedbackHomeComponent;
            }());
            FeedbackHomeComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fortawesome/free-solid-svg-icons */ "./node_modules/@fortawesome/free-solid-svg-icons/index.es.js");
            var HomeContactsComponent = /** @class */ (function () {
                function HomeContactsComponent() {
                    this.faPhoneAlt = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faPhoneAlt"];
                    this.faMapMarkerAlt = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faMapMarkerAlt"];
                    this.faClock = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faClock"];
                    this.faPizzaSlice = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faPizzaSlice"];
                }
                HomeContactsComponent.prototype.ngOnInit = function () {
                };
                return HomeContactsComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var HomeFeedbackComponent = /** @class */ (function () {
                function HomeFeedbackComponent() {
                }
                HomeFeedbackComponent.prototype.ngOnInit = function () {
                };
                return HomeFeedbackComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeGuestsComponent = /** @class */ (function () {
                function HomeGuestsComponent(guestService) {
                    this.guestService = guestService;
                    this.guests = [];
                }
                HomeGuestsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.guestService.getData().subscribe(function (actionArray) {
                        _this.guests = actionArray.map(function (guests) {
                            return Object.assign({ id: guests.payload.doc.id }, guests.payload.doc.data());
                        });
                    });
                    this.guestService.getType().subscribe(function (actionArray) {
                        _this.mainType = actionArray.map(function (type) {
                            return Object.assign({ id: type.payload.doc.id }, type.payload.doc.data());
                        });
                        _this.mainTypeHTML = _this.mainType[0].name;
                    });
                };
                ;
                HomeGuestsComponent.prototype.ngAfterViewInit = function () {
                ...
                ;
                return HomeGuestsComponent;
            }());
            HomeGuestsComponent.ctorParameters = function () { return [
                { type: src_app_shared_services_guest_service__WEBPACK_IMPORTED_MODULE_2__["GuestService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MenuComponent = /** @class */ (function () {
                function MenuComponent(categoryService, productService, route, localStorageService, paginatorService, routeLink, dialog, modalService, notificationsService) {
                    this.categoryService = categoryService;
                    this.productService = productService;
                    this.route = route;
                    this.localStorageService = localStorageService;
                ...
                MenuComponent.prototype.ngOnInit = function () {
                    ...
                    this.productService.getData().subscribe(function (actionArray) {
                        ...
                        _this.paginatorService.currentPage.subscribe(function (page) { return _this.page = page; });
                        _this.isActiveModal = _this.checkWindowShow();
                    });
                };
                ...
                ;
                MenuComponent.prototype.selectCategory = function (name) {
                    this.categoryName = name || this.route.snapshot.paramMap.get('category');
                    this.filterCategory(this.categoryName);
                    this.selected = name || this.route.snapshot.paramMap.get('category');
                };
                ;
                MenuComponent.prototype.filterCategory = function (name) {
                    var _this = this;
                    this.filterCategoryName = name;
                    this.filterProducts = this.products.filter(function (val) { return val.category === _this.filterCategoryName.trim(); });
                ...
                ;
                MenuComponent.prototype.countProductsInc = function (product) {
                    product.count++;
                };
                ;
                MenuComponent.prototype.countProductsDec = function (product) {
                    if (product.count > 1) {
                        product.count--;
                    }
                };
                ...
                MenuComponent.prototype.checkCountProduct = function (event, product) {
                    var regExp = /^[1-9]{1}([0-9]{1})?([0-9]{1})?$/;
                    var check = regExp.test(event.target.value);
                    if (check) {
                        product.count = Number(event.target.value);
                ...
                ;
                MenuComponent.prototype.orderInLocalST = function (product, template) {
                    var newOrder = new src_app_shared_classes_product_model__WEBPACK_IMPORTED_MODULE_5__["Product"](product.category, product.name, product.description, product.price, product.count, product.image, product.size, product.weight, product.id);
                ...
                ;
                MenuComponent.prototype.scrollUp = function () {
                    window.scroll(0, 0);
                };
                ;
                ...
                ;
                MenuComponent.prototype.checkWindowShow = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductDetailsComponent = /** @class */ (function () {
                ...
                ProductDetailsComponent.prototype.getProduct = function () {
                    ...
                    this.productService.getData().subscribe(function (actionArray) {
                        _this.products = actionArray.map(function (products) {
                            return Object.assign({ id: products.payload.doc.id }, products.payload.doc.data());
                        });
                        _this.oneProduct = _this.products.filter(function (product) { return product.category === _this.productCategory && product.name === _this.productName; });
                    });
                };
                ;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Guest = /** @class */ (function () {
                function Guest(name, photo, quote, details, id) {
                    this.name = name;
                    this.photo = photo;
                    this.quote = quote;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Order = /** @class */ (function () {
                function Order(name, adress, number, date, product, isNew, id) {
                    this.name = name;
                    this.adress = adress;
                    this.number = number;
                    this.date = date;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Post = /** @class */ (function () {
                function Post(text, writtenBy, date, id) {
                    this.text = text;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Product = /** @class */ (function () {
                function Product(category, name, description, price, count, image, size, weight, id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var User = /** @class */ (function () {
                function User(username, email, password, blacklist, id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CategoryPipe = /** @class */ (function () {
                ...
                CategoryPipe.prototype.transform = function (arr, searchCategory) {
                    return arr.filter(function (products) { return products.category === searchCategory; });
                };
                return CategoryPipe;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArchiveService = /** @class */ (function () {
                function ArchiveService(firestore) {
                    this.firestore = firestore;
                }
                ArchiveService.prototype.getData = function () {
                    return this.firestore.collection('archive').snapshotChanges();
                };
                ;
                ArchiveService.prototype.deleteArray = function (orders) {
                    var _this = this;
                    orders.forEach(function (value) {
                        _this.firestore.doc('archive/' + value.id).delete();
                    });
                };
                ;
                ArchiveService.prototype.setData = function (order) {
                    this.firestore.collection('archive').add(JSON.parse(JSON.stringify(order)));
                };
                ;
                return ArchiveService;
            }());
            ArchiveService.ctorParameters = function () { return [
                { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BlacklistService = /** @class */ (function () {
                function BlacklistService(firestore) {
                    this.firestore = firestore;
                }
                BlacklistService.prototype.getData = function () {
                    return this.firestore.collection('blacklist').snapshotChanges();
                };
                ;
                BlacklistService.prototype.setData = function (editedUser) {
                    this.firestore.collection('blacklist').add(JSON.parse(JSON.stringify(editedUser)));
                };
                ;
                BlacklistService.prototype.updateData = function (editedUser, id) {
                    this.firestore.doc('users/' + id).update(JSON.parse(JSON.stringify(editedUser)));
                };
                ;
                BlacklistService.prototype.deleteData = function (user) {
                    this.firestore.doc('blacklist/' + user.id).delete();
                };
                ;
                return BlacklistService;
            }());
            BlacklistService.ctorParameters = function () { return [
                { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CategoryService = /** @class */ (function () {
                ...
                ;
                CategoryService.prototype.deleteData = function (cloud) {
                    this.firestore.doc('categories/' + cloud.id).delete();
                };
                ;
                CategoryService.prototype.deleteArrayOfProducts = function (products) {
                    var _this = this;
                    products.forEach(function (value) {
                        _this.firestore.doc('products/' + value.id).delete();
                    });
                };
                ;
                CategoryService.prototype.setData = function (newCategory) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuestService = /** @class */ (function () {
                function GuestService(firestore) {
                    this.firestore = firestore;
                }
                GuestService.prototype.getData = function () {
                    return this.firestore.collection('guests').snapshotChanges();
                };
                ;
                GuestService.prototype.deleteData = function (cloud) {
                    this.firestore.doc('guests/' + cloud.id).delete();
                };
                ;
                GuestService.prototype.updateData = function (newGuest, id) {
                    this.firestore.doc('guests/' + id).update(JSON.parse(JSON.stringify(newGuest)));
                };
                ;
                GuestService.prototype.setData = function (newGuest) {
                    this.firestore.collection('guests').add(JSON.parse(JSON.stringify(newGuest)));
                };
                ;
                GuestService.prototype.getType = function () {
                    return this.firestore.collection('types').snapshotChanges();
                };
                ;
                GuestService.prototype.updateType = function (newType, id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LocalStorageService = /** @class */ (function () {
                function LocalStorageService(route) {
                    this.route = route;
                    this.ordersStream = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
                }
                LocalStorageService.prototype.addProductLocalStorage = function (newProduct) {
                    var products = this.getDataLocalStorage('Products');
                    if (products.length > 0) {
                        if (products.find(function (elem) { return elem.id === newProduct.id; })) {
                            var index = products.findIndex(function (elem) { return elem.id === newProduct.id; });
                ...
                LocalStorageService.prototype.getDataLocalStorage = function (subject) {
                ...
                ;
                LocalStorageService.prototype.setProductLocalStorage = function (item) {
                    localStorage.setItem('Products', JSON.stringify(item));
                    this.getOrderCount(item);
                };
                ;
                LocalStorageService.prototype.getOrderCount = function (newProd) {
                    this.ordersStream.next(newProd);
                };
                ;
                LocalStorageService.prototype.setUserLocalStorage = function (item) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OrderService = /** @class */ (function () {
                ...
                ;
                OrderService.prototype.deleteData = function (cloud) {
                    this.firestore.doc('orders/' + cloud.id).delete();
                };
                ;
                OrderService.prototype.updateData = function (newOrder, id) {
                    this.firestore.doc('orders/' + id).update(JSON.parse(JSON.stringify(newOrder)));
                };
                ;
                OrderService.prototype.setData = function (newOrder) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaginatorService = /** @class */ (function () {
                ...
                PaginatorService.prototype.changePage = function (page) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostService = /** @class */ (function () {
                ...
                ;
                PostService.prototype.deleteData = function (post) {
                    this.firestore.doc('posts/' + post.id).delete();
                };
                ;
                PostService.prototype.updateData = function (newPost, id) {
                    this.firestore.doc('posts/' + id).update(JSON.parse(JSON.stringify(newPost)));
                };
                ;
                PostService.prototype.setData = function (newPost) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductDetailsService = /** @class */ (function () {
                function ProductDetailsService(firestore) {
                    this.firestore = firestore;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductService = /** @class */ (function () {
                function ProductService(firestore) {
                    this.firestore = firestore;
                }
                ...
                ;
                ProductService.prototype.deleteData = function (product) {
                    this.firestore.doc('products/' + product.id).delete();
                };
                ;
                ProductService.prototype.updateData = function (newProduct, id) {
                    this.firestore.doc('products/' + id).update(JSON.parse(JSON.stringify(newProduct)));
                };
                ;
                ProductService.prototype.setData = function (newProduct) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                ;
                UserService.prototype.setData = function (newUser) {
                    var user = JSON.parse(JSON.stringify(newUser));
                    this.firestore.collection('users').add(user);
                };
                ;
                UserService.prototype.updateData = function (editedUser, id, userPosts) {
                    var _this = this;
                    this.firestore.doc('users/' + id).update(JSON.parse(JSON.stringify(editedUser)));
                    if (userPosts) {
                        userPosts.forEach(function (value) {
                            _this.firestore.doc('posts/' + value.id).delete();
                        });
                    }
                };
                ;
                UserService.prototype.setItemLocalStorage = function (item) {
                    localStorage.setItem('User', JSON.stringify([item]));
                };
                ;
                return UserService;
